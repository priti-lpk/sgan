                ...
                <div class="row">
                    <div class="col-lg-12 ml-10">
                        <a href="admin/Images/Form/Add_Registration.pdf" download>   
                            <button class="btn btn-primary m-2 col-lg-3"id="btn_save" type="submit" value="send" href = '' class = 'btn btn-default btn-sm' data-toggle = 'modal'><i class="ti-import"></i>&nbsp; &nbsp;REGISTRATION FORM</button>
                        </a>
                        <a href="admin/Images/Form/Add_Admission.pdf" download>   
                            <button class="btn btn-primary m-2 col-lg-3"id="btn_save" type="submit" value="send" href = '' class = 'btn btn-default btn-sm' data-toggle = 'modal'><i class="ti-import"></i>&nbsp; &nbsp;ADMISSION FORM</button>
                        </a>
                        <a href="admin/Images/Form/Add_Hostal_Schedule.pdf" download>   
                            <button class="btn btn-primary m-2 col-lg-3"id="btn_save" type="submit" value="send" href = '' class = 'btn btn-default btn-sm' data-toggle = 'modal'><i class="ti-import"></i>&nbsp; &nbsp;HOSTEL FORM</button>
                        </a>
                    </div>
                </div>
            </div>
