...
if (isset($_GET['type']) && isset($_GET['id'])) {
    ...
    $field = array("*");
    $data = $edba->getRow("album_list", $field, "id=" . $_GET['id']);
...
<html lang="en">
    ...
    <head>
        ...
        <title><?php
            if (isset($_GET['type']) && isset($_GET['id'])) {
                echo 'Edit Create Album';
            } else {
                echo 'Add Create Album';
            }
            ?></title>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="customFile/createAlbumPro.php" id="form_data" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                <h4 class="mt-0 header-title">Textual inputs</h4>
                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Select Year</label>
                                                    <div class="col-sm-4">
...
//                                                            echo "<option  value='" . $subData[0] . "'>" . $subData[1] . "</option> ";
                                                    ...
                                                    <!--                                                </div>
                                                                                                    <div class="form-group row">-->
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Create Album</label>
                                                    <div class="col-sm-4">
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Album List</h4><br>
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    $dba = new DBAdapter();
                                                    $field = array("*");
                                                    $data = $dba->getRow("album_list INNER JOIN year_list ON album_list.year_id=year_list.id", $field, "1");
                                                    $count = count($data);
                                                    $k = 1;
                                                    if ($count >= 1) {
                                                        foreach ($data as $subData) {
                                                            ...
                                                            echo "<td><a href='create_album.php?type=sedit&id=" . $subData[0] . "' class='btn btn-primary' id='" . $subData[0] . "'><i class='fa fa-edit'></i> Edit</a> <button class='btn btn-danger btn_delete' id='" . $subData[0] . "' onclick='SetForDelete(this.id);'><i class='fa fa-trash-o'>  Delete</button></td>";
        ...
        <script type="text/javascript">
            ...
            function SetForDelete(id) {
                location.href = "Delete.php?type=create_album&id=" + id;
