...
if (isset($_GET['type']) && isset($_GET['id'])) {
    ...
    $field = array("*");
    $data = $edba->getRow("create_class", $field, "id=" . $_GET['id']);
...
<html lang="en">
    ...
    <head>
        ...
        <title><?php
            if (isset($_GET['type']) && isset($_GET['id'])) {
                echo 'Edit Create Class';
            } else {
                echo 'Add Create Class';
            }
            ?></title>
    ...
    <body>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="customFile/create_classPro.php" id="form_data" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Class List</h4><br>
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($count >= 1) {
                                                        foreach ($data as $subData) {
                                                            ...
                                                            echo "<td><a href='create_class.php?type=edit&id=" . $subData[0] . "' class='btn btn-primary' id='" . $subData[0] . "'><i class='fa fa-edit'></i> Edit</a> <button class='btn btn-danger btn_delete' id='" . $subData[0] . "' onclick='SetForDelete(this.id);'><i class='fa fa-trash-o'>  Delete</button></td>";
        ...
        <script type="text/javascript">
            ...
            function SetForDelete(id) {
                location.href = "Delete.php?type=create_class&id=" + id;
