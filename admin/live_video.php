...
if (isset($_GET['type']) && isset($_GET['id'])) {
    ...
    $field = array("*");
    $data = $edba->getRow("live_video", $field, "id=" . $_GET['id']);
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">                   
                                            <form action="customFile/live_videoPro.php" id="form_data" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >  
                                                <h4 class="mt-0 header-title">Textual inputs</h4>
                                                <div class="form-group row">
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Date</label>
                                                    <div class="col-sm-4">
                                                        <input class="form-control" type="date"  placeholder="Date" id="live_date" name="live_date" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][3] : ''); ?>" required="">
                                                    </div>
                                                    <label for="example-text-input" class="col-sm-2 col-form-label">Live Video Id</label>
                                                    <div class="col-sm-4">
                                                        <input class="form-control" type="text"  placeholder="Live Video Id" id="live_title" name="live_title" value="<?php echo (isset($_GET['type']) && isset($_GET['id']) ? $edata[0][4] : ''); ?>" required="">
                                                    </div>
                                                </div>
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Live Videos List</h4><br>
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    $dba = new DBAdapter();
                                                    $field = array("*");
                                                    $data = $dba->getRow("live_video", $field, "1 order by id desc");
                                                    $count = count($data);
                                                    $k = 1;
                                                    if ($count >= 1) {
...
//                                                                          
        ...
        <script type="text/javascript">
            ...
            function SetForDelete(id) {
                location.href = "Delete.php?type=live_video&id=" + id;
